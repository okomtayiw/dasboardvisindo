            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Form <small>Edit Transaction</small></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="form_edit" method="POST" action="<?php echo base_url('Transaction/saveUpdateDataTransaction') ?>">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="dateInvoice" value="<?php echo $rows['date_invoice'];?>" class="form-control" placeholder="Tgl. Penagihan" id="datepicker">
                            </div>
                            <div class="form-group">
                                <label>Jatuh Tempo</label>
                                <input type="text"  name="dueDate" value="<?php echo $rows['due_date'];?>" class="form-control" placeholder="Jatuh Tempo" id="datepickertwo">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <select class="form-control" name="nmStatus" id="nmStatus">
                                    ...
                                    foreach (array('Belum Lunas', 'Lunas') as $status) { ?>
                                        <option value="<?php echo $status; ?>"<?php if (!(strcmp($status, $rows['status_transaction']))) {echo "selected=\"selected\"";} ?>><?php echo $status?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
